...
@Component({
  selector: 'app-turnos-solicitados-grafico',
  standalone: true,
  imports: [FormsModule, RouterModule, CommonModule, SpinnerComponent],
  templateUrl: './turnos-solicitados-grafico.component.html',
  styleUrl: './turnos-solicitados-grafico.component.css'
})
export class TurnosSolicitadosGraficoComponent implements OnInit {
  ...
  async buscar() : Promise<void>
  {
    ...
    }).filter(turno => turno.estado == 'aprobado');
